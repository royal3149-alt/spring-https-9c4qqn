    ...
    <div className="border border-[#e5d5b0] p-1 mb-10">
      <div className="border border-[#e5d5b0] px-10 py-16 md:px-16 md:py-24 bg-[#1a1a1a]">
        ...
        <p className="text-[#a89f91] max-w-sm mx-auto leading-loose font-serif text-sm">
          ...
          <br />
          <br />
          <span className="text-[#e5d5b0] italic font-medium tracking-wide">
    ...
    <div className="h-full flex flex-col items-center justify-start pt-20 p-4 animate-fade-in overflow-y-auto no-scrollbar relative z-10">
      <div className="w-full max-w-4xl bg-[#151515] p-6 md:p-10 border border-[#333] grid grid-cols-1 md:grid-cols-2 gap-10 rounded-sm">
        <div className="space-y-8">
              ...
              openDates.map((d) => (
                <button
                  ...
                  className={`py-2 text-xs border transition-colors ${
                    data.date === d
                      ? "bg-[#e5d5b0] text-black border-[#e5d5b0]"
          ...
          <div className="grid grid-cols-4 gap-2">
            {slots.length > 0
              ...
              : data.date && (
                  <div className="text-zinc-600 text-xs italic col-span-4">
                    本日時段已預訂滿
                  </div>
                )}
          </div>
        ...
        <div className="space-y-6 flex flex-col justify-between">
          <div>
            <h3 className="text-[#e5d5b0] font-serif text-xl mb-6">聯絡資訊</h3>
            <input
              placeholder="Your Name"
              value={data.name}
              className="w-full bg-transparent border-b border-[#333] py-3 text-white outline-none focus:border-[#4a0404] font-serif"
            ...
            <textarea
              ...
              className="w-full bg-black/40 border border-[#333] p-4 text-white h-24 mt-4 outline-none focus:border-[#4a0404] font-serif"
      ...
      <div className="w-full max-w-sm aspect-[9/16] relative overflow-hidden flex flex-col justify-end shadow-[0_40px_100px_rgba(0,0,0,1)] rounded-b-[48px] md:rounded-[48px] md:mt-8 bg-[#0a0a0a]">
        ...
        <div className="relative z-10 p-10 text-center pb-14">
          ...
          <div className="mb-12">
            ...
            <p className="text-[12px] text-white font-bold tracking-[0.4em] font-mono bg-black/60 px-6 py-2 rounded-full border border-white/10 backdrop-blur-md inline-block uppercase whitespace-nowrap shadow-lg">
              {persona.en}
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <a
              ...
              className="bg-white p-1.5 rounded shadow-2xl transition-transform hover:scale-110 flex flex-col items-center group"
            >
              <img
      ...
      {view === "bookings" ? (
        <div className="space-y-4">
          {reservations.map((res) => (
            ...
            >
              ...
              <div className="mt-2 text-zinc-400 text-sm font-serif">
                {res.date} {res.time}
              </div>
              {res.note && (
        ...
        <div className="space-y-4">
          {Object.keys(availability).map((d) => (
            <div
              key={d}
              className="p-6 bg-[#111] border border-[#222] rounded-2xl flex justify-between items-center transition-colors hover:border-[#4a0404]"
            >
              <span className="text-[#e5d5b0] font-mono tracking-widest">
                {d}
              </span>
              <button
                onClick={() => onUpdateAvailability(d, null)}
                className="text-red-900 text-[10px] font-bold tracking-widest uppercase hover:text-red-500"
              >
                Close Date
              </button>
            </div>
          ...
          <div className="p-8 border border-dashed border-[#333] text-center rounded-2xl bg-[#0a0a0a]">
            <input
              type="date"
              className="bg-black border border-[#222] text-white p-3 rounded-lg outline-none focus:border-[#e5d5b0]"
              id="newD"
            />
            <button
              className="ml-4 text-[#e5d5b0] font-bold uppercase text-xs tracking-widest hover:text-white"
              onClick={() => {
